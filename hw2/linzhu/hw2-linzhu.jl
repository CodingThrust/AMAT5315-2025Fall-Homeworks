...
# 683.007 ns (0 allocations: 0 bytes)
# 9911.000412606943

println("Broadcasting version:")
@btime sum_squares_broadcast($x)
# 4.633 μs (3 allocations: 78.20 KiB)
# 9911.000412606943
...
#  from unstable_function(n::Int64) @ Main c:\Users\ZL137\Desktop\hw2.jl:1
#Arguments
...
# 626.100 μs (0 allocations: 0 bytes)
# 5.000005e11
