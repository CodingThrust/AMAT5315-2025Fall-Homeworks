...
Ans: 
codes are in `svd_compress.jl`, error are plotted in `errors.png`, reconstructed images are `top_10_compressed.png`, `top_50_compressed.png`, `top_100_compressed.png`, `top_200_compressed.png`.
...
Ans:
codes are in `fft_compress.jl`, reconstructed images are `fft_compression_comparison.png`.
