...
flattened_image = reshape(test_images, 28*28, :)
...
save("hw5/reference/original_image.png",gray_img_ini)
save("hw5/reference/compressed_image.png",map(clamp01nan, gray_img_compressed))
...
savefig("hw5/reference/compressed_ratio.png")
plot(maxDim,err,xlabel="k",ylabel = "error",label=false,title="reconstructed error")
savefig("hw5/reference/reconstructed_error.png")