...
the visualize and compare the original vs. reconstructed images is the file called "svd_compression_multiple_samples.png".
![svd_compression_multiple_samples.png](svd_compression_multiple_samples.png)

Plots of the compression ratio and reconstruction error are in the fle called "svd_compression_ratio.png" and "svd_reconstruction_error.png".

![svd_compression_ratio.png](svd_compression_ratio.png)

![svd_reconstruction_error.png](svd_reconstruction_error.png)

## Problem 2

It is easy to see that HSV compressed image mainly keeps the difference of color saturation of the origin rather than colors, while RGB compressed image is more focusing on colors preservation.

![compressed_hsv.png](compressed_hsv.png)
*HSV compressed*
![compressed_rgb.png](compressed_rgb.png)
*RGB compressed*
